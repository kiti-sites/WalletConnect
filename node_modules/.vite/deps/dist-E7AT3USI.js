import {
  ...
  require_sha3,
  require_utils
} from "./chunk-FCOHYERN.js";
import {
  require_dist
} from "./chunk-OV7BKIOL.js";
import {
  init_native,
  native_exports
} from "./chunk-C62S6MLH.js";
import {
  require_events
      ...
      async request(request) {
        ...
        switch (method) {
          ...
          case "wallet_getCallsStatus": {
            ...
            const tx2 = await this.sdk.txs.getBySafeTxHash(params[0]).catch(() => null);
            if (!(tx2 == null ? void 0 : tx2.txHash)) {
              throw new Error("Transaction not found");
            }
            const receipt = await this.sdk.eth.getTransactionReceipt([tx2.txHash]).catch(() => null);
            if (!receipt) {
            ...
            const receipts = Array(calls).fill({
              success: (0, utils_1.numberToHex)(tx2.txStatus === safe_apps_sdk_1.TransactionStatus.SUCCESS ? 1 : 0),
              blockHash: receipt.blockHash,
              blockNumber: (0, utils_1.numberToHex)(blockNumber),
              blockTimestamp: (0, utils_1.numberToHex)(tx2.executedAt ?? 0),
...
@noble/curves/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=dist-E7AT3USI.js.map
