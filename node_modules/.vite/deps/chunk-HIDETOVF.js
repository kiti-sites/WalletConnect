...
var OptionsController = {
  ...
  setFeatures(features) {
    ...
    Object.entries(features).forEach(([key, value]) => {
      if (!state2.features) {
        state2.features = ConstantsUtil2.DEFAULT_FEATURES;
      }
      if (key in state2.features) {
        ;
        state2.features[key] = value;
      }
    });
  },
  ...
  setIsUniversalProvider(isUniversalProvider) {
    state2.isUniversalProvider = isUniversalProvider;
  },
  ...
  setEIP6963Enabled(enableEIP6963) {
    state2.enableEIP6963 = enableEIP6963;
  },
  setDebug(debug) {
    state2.debug = debug;
  },
  setEnableWalletConnect(enableWalletConnect) {
    state2.enableWalletConnect = enableWalletConnect;
  },
  setEnableWallets(enableWallets) {
    state2.enableWallets = enableWallets;
  },
  setHasMultipleAddresses(hasMultipleAddresses) {
    state2.hasMultipleAddresses = hasMultipleAddresses;
  },
  setSIWX(siwx) {
    state2.siwx = siwx;
  }
...
var SnackController = {
  ...
  _showMessage({ message, svg: svg2, variant = "success" }) {
    if (state4.open) {
      state4.open = false;
      setTimeout(() => {
    ...
    this.events = {
      registerFrameEventHandler: (id, callback, signal) => {
        function eventHandler({ data }) {
          if (typeof data.type !== "string" || !data.type.includes(W3mFrameConstants.FRAME_EVENT_KEY)) {
            return;
          }
      ...
      onAppEvent: (callback) => {
        if (W3mFrameHelpers.isClient) {
          window.addEventListener("message", ({ data }) => {
            if (typeof data.type !== "string" || !data.type.includes(W3mFrameConstants.APP_EVENT_KEY)) {
              return;
            }
...
var TransactionsController = {
  ...
  setLastNetworkInView(lastNetworkInView) {
    state6.lastNetworkInView = lastNetworkInView;
  },
  async fetchTransactions(accountAddress, onramp) {
    ...
    try {
      ...
      const filteredTransactions = [...state6.transactions, ...sameChainTransactions];
      state6.loading = false;
      if (onramp === "coinbase") {
        state6.coinbaseTransactions = this.groupTransactionsByYearAndMonth(state6.coinbaseTransactions, response.data);
      } else {
        state6.transactions = filteredTransactions;
        state6.transactionsByYear = this.groupTransactionsByYearAndMonth(state6.transactionsByYear, sameChainTransactions);
      }
      state6.empty = filteredTransactions.length === 0;
      state6.next = response.next ? response.next : void 0;
    } catch (error) {
  ...
  resetTransactions() {
    state6.transactions = [];
    state6.transactionsByYear = {};
    state6.lastNetworkInView = void 0;
    state6.loading = false;
    state6.empty = false;
    state6.next = void 0;
  }
...
var ConnectorController = {
  ...
  setConnectors(connectors) {
    ...
    newConnectors.forEach((connector) => {
      state8.allConnectors.push(ref(connector));
    });
  ...
  mergeMultiChainConnectors(connectors) {
    ...
    connectorsByNameMap.forEach((keyConnectors) => {
      ...
      const isAuthConnector = (firstItem == null ? void 0 : firstItem.id) === "ID_AUTH";
  ...
  getAuthConnector() {
    ...
    const authConnector = state8.connectors.find((c) => c.id === "ID_AUTH");
    if (!authConnector) {
      return void 0;
    }
  ...
  getAnnouncedConnectorRdns() {
    return state8.connectors.filter((c) => c.type === "ANNOUNCED").map((c) => {
      var _a6;
      return (_a6 = c.info) == null ? void 0 : _a6.rdns;
    });
  },
  getConnectors() {
    return state8.connectors;
  },
  getConnector(id, rdns) {
    return state8.connectors.find((c) => {
      var _a6;
...
var ConnectionController = {
  ...
  async connectWalletConnect() {
    ...
    if (CoreHelperUtil.isTelegram()) {
      ...
      await ((_b3 = (_a6 = this._getClient()) == null ? void 0 : _a6.connectWalletConnect) == null ? void 0 : _b3.call(_a6, (uri) => {
        state9.wcUri = uri;
        state9.wcPairingExpiry = CoreHelperUtil.getPairingExpiry();
      }));
    }
  ...
  async disconnect() {
    try {
      ...
      await (connectionControllerClient == null ? void 0 : connectionControllerClient.disconnect());
...
var RouterController = {
  ...
  goBack() {
    if (state10.history.length > 1 && !state10.history.includes("UnsupportedChain")) {
      state10.history.pop();
...
var SwapController = {
  ...
  getParams() {
    ...
    return {
      ...
      sourceTokenAddress: (_e = state11.sourceToken) == null ? void 0 : _e.address,
  ...
  async sendTransactionForSwap(data) {
    ...
    try {
      const forceUpdateAddresses = [(_e = state11.sourceToken) == null ? void 0 : _e.address, (_f = state11.toToken) == null ? void 0 : _f.address].join(",");
...
var AccountController = {
  ...
  replaceState(newState) {
    ...
    Object.assign(state12, ref(newState));
  },
  subscribe(callback) {
...
var ChainController = {
  ...
  setAdapterNetworkState(chain, props) {
    ...
    if (chainAdapter) {
      ...
      state14.chains.set(chain, ref(chainAdapter));
    }
  },
  ...
  setActiveCaipNetwork(caipNetwork) {
    ...
    state14.activeCaipNetwork = caipNetwork;
    state14.activeCaipAddress = (_a6 = newAdapter == null ? void 0 : newAdapter.accountState) == null ? void 0 : _a6.caipAddress;
    if (newAdapter) {
      AccountController.replaceState(newAdapter.accountState);
    }
    PublicStateController.set({
      activeChain: state14.activeChain,
      selectedNetworkId: (_b3 = state14.activeCaipNetwork) == null ? void 0 : _b3.caipNetworkId
    });
...
var StorageUtil = {
  ...
  getStoredActiveCaipNetwork() {
    ...
    const storedCaipNetwork = allRequestedCaipNetworks == null ? void 0 : allRequestedCaipNetworks.find((c) => c.caipNetworkId === storedCaipNetworkId);
...
var AssetController = {
  ...
  subscribeNetworkImages(callback) {
    return subscribe(state15.networkImages, () => callback(state15.networkImages));
  },
  subscribeKey(key, callback) {
  ...
  setWalletImage(key, value) {
    state15.walletImages[key] = value;
  },
  setNetworkImage(key, value) {
    state15.networkImages[key] = value;
  },
  setChainImage(key, value) {
    state15.chainImages[key] = value;
  },
  setConnectorImage(key, value) {
    state15.connectorImages[key] = value;
  },
  setTokenImage(key, value) {
    state15.tokenImages[key] = value;
  },
  setCurrencyImage(key, value) {
    state15.currencyImages[key] = value;
  }
};
    ...
    if (((_a6 = this.state.token) == null ? void 0 : _a6.address) && this.state.sendTokenAmount && this.state.receiverAddress) {
      ...
      EventsController.sendEvent({
        ...
        properties: {
          ...
          amount: this.state.sendTokenAmount,
          network: ((_e = ChainController.state.activeCaipNetwork) == null ? void 0 : _e.caipNetworkId) || ""
        }
      });
...
var SIWXUtil = {
  ...
  async universalProviderAuthenticate({ universalProvider, chains, methods }) {
    ...
    if ((_a6 = result == null ? void 0 : result.auths) == null ? void 0 : _a6.length) {
...
WuiNoticeCard.styles = [resetStyles, elementStyles, styles_default52];
__decorate52([
  property()
...
WuiListAccordion.styles = [resetStyles, elementStyles, styles_default53];
__decorate53([
  property()
...
WuiListContent.styles = [resetStyles, elementStyles, styles_default54];
__decorate54([
  property()
...
WuiListNetwork.styles = [resetStyles, elementStyles, styles_default55];
__decorate55([
  property()
...
WuiListWalletTransaction.styles = [resetStyles, elementStyles, styles_default56];
__decorate56([
  property()
...
WuiListWalletTransaction = __decorate56([
...
WuiProfileButtonV2.styles = [resetStyles, elementStyles, styles_default60];
__decorate60([
  property()
...
WuiProfileButtonV2 = __decorate60([
...
WuiChipButton.styles = [resetStyles, elementStyles, styles_default61];
__decorate61([
  property()
...
WuiCompatibleNetwork.styles = [resetStyles, elementStyles, styles_default62];
__decorate62([
  property({ type: Array })
...
WuiCompatibleNetwork = __decorate62([
...
WuiBanner.styles = [resetStyles, elementStyles, styles_default63];
__decorate63([
  property()
...
WuiBannerImg.styles = [resetStyles, elementStyles, styles_default64];
__decorate64([
  property()
...
WuiListToken.styles = [resetStyles, elementStyles, styles_default65];
__decorate65([
  property()
...
WuiListDescription.styles = [resetStyles, elementStyles, styles_default66];
__decorate66([
  property()
...
WuiListDescription = __decorate66([
...
WuiInputAmount.styles = [resetStyles, elementStyles, styles_default67];
__decorate67([
  property({ type: Boolean })
...
WuiPreviewItem.styles = [resetStyles, elementStyles, styles_default68];
__decorate68([
  property()
...
WuiListAccount.styles = [resetStyles, elementStyles, styles_default69];
__decorate69([
  property()
...
WuiIconButton.styles = [resetStyles, elementStyles, styles_default70];
__decorate70([
  property()
...
WuiListButton.styles = [resetStyles, elementStyles, styles_default71];
__decorate71([
  property()
...
WuiListSocial.styles = [resetStyles, elementStyles, styles_default72];
__decorate72([
  property()
...
WuiSelect.styles = [resetStyles, elementStyles, colorStyles, styles_default73];
__decorate73([
  property()
], WuiSelect.prototype, "imageSrc", void 0);
WuiSelect = __decorate73([
...
WuiCheckBox.styles = [resetStyles, styles_default74];
__decorate74([
  property({ type: Boolean })
], WuiCheckBox.prototype, "checked", void 0);
WuiCheckBox = __decorate74([
...
WuiSwitch.styles = [resetStyles, elementStyles, colorStyles, styles_default75];
__decorate75([
  property({ type: Boolean })
], WuiSwitch.prototype, "checked", void 0);
WuiSwitch = __decorate75([
...
WuiCertifiedSwitch.styles = [resetStyles, elementStyles, styles_default76];
__decorate76([
  property({ type: Boolean })
], WuiCertifiedSwitch.prototype, "checked", void 0);
WuiCertifiedSwitch = __decorate76([
...
WuiGrid.styles = [resetStyles, styles_default77];
__decorate77([
  property()
...
WuiSeparator.styles = [resetStyles, styles_default78];
__decorate78([
  property()
], WuiSeparator.prototype, "text", void 0);
WuiSeparator = __decorate78([
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HIDETOVF.js.map
